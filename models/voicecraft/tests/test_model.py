...
class TestConfig(BaseModelConfigTests):
    PACKAGE_NAME = "ttsdb_voicecraft"
    EXPECTED_MODEL_NAME = "VoiceCraft"
    EXPECTED_SAMPLE_RATE = 16000


class TestModelImport(BaseModelImportTests):
    PACKAGE_NAME = "ttsdb_voicecraft"
    MODEL_CLASS_PATH = "ttsdb_voicecraft.VoiceCraft"
...
class TestModelIntegration(BaseModelIntegrationTests):
    PACKAGE_NAME = "ttsdb_voicecraft"
    MODEL_CLASS_PATH = "ttsdb_voicecraft.VoiceCraft"
    WEIGHTS_PREPARE_HINT = "voicecraft"
    EXPECTED_SAMPLE_RATE = 16000
